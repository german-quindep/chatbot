...
public class TelegramBotController {
    ...
    public ResponseBot getHola(@RequestBody TBotModel tBotModel) {
        ResponseBot responseBot = new ResponseBot(MenuUsers.getMenuPrincipal(),
                "Gracias por usar el bot" + tBotModel.getTipo_mensaje());
        return responseBot;
    }

    @PostMapping("${api.bot.help}")
    public String getHelp(@RequestBody TBotModel tBotModel) {
        return "¿Que ayuda requieres?" + tBotModel.getTipo_mensaje();
    }
    ...
    public ResponseBot getColaboradorActivo(@RequestBody TBotModel tBotModel) {
        ResponseBot responseBot = new ResponseBot(MenuUsers.getMenuColaborador(),
                "Ok eres colaborador activo" + tBotModel.getTipo_mensaje());
        return responseBot;
    }
    ...
    public ResponseBot getCertificadoLaboral(@RequestBody TBotModel tBotModel) {
        ResponseBot responseBot = new ResponseBot(MenuUsers.getMenuCertificados(),
                "Ok necesitas un certificado" + tBotModel.getTipo_mensaje());
        return responseBot;
    }
    ...
    public ResponseBot getComision(@RequestBody TBotModel tBotModel) {
        ResponseBot responseBot = new ResponseBot(MenuUsers.getMenuPrincipal(),
                "Ok te genero el certificado de comision" + tBotModel.getTipo_mensaje());
        return responseBot;
    }
    ...
    public ResponseBot getIngresos(@RequestBody TBotModel tBotModel) {
        ResponseBot responseBot = new ResponseBot(MenuUsers.getMenuPrincipal(),
                "Ok te genero el certificado de ingresos" + tBotModel.getTipo_mensaje());
        return responseBot;
    }
    ...
    public ResponseBot getSinIngresos(@RequestBody TBotModel tBotModel) {
        ResponseBot responseBot = new ResponseBot(MenuUsers.getMenuPrincipal(),
                "Ok te genero el certificado sin ingresos" + tBotModel.getTipo_mensaje());
        return responseBot;
    }
    ...
    public ResponseBot getPasante(@RequestBody TBotModel tBotModel) {
        ResponseBot responseBot = new ResponseBot(MenuUsers.getMenuPrincipal(),
                "Ok te genero el certificado de pasanstes" + tBotModel.getTipo_mensaje());
        return responseBot;
    }
